...
public class TestDozerModelTransformerTest {
	...
	private TestDozerModelTransformer objectUnderTest;

	@BeforeMethod
	public void setUp() {
		// CDI: @Autowired, @Inject, etc.
		objectUnderTest = new TestDozerModelTransformer(
				new TestReflectionModelTransformerFactory(
						singleton(new TestDozerModelTransformerProvider(
								new DozerBeanMapper()))));
